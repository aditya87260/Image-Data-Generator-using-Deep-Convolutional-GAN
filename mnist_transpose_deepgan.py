...
generator.add(Conv2DTranspose(1, kernel_size=(5,5), strides=(2, 2), padding='same'))# Double the  Size again and reduce channel to 1 so now new size of image is  28 X 28 X 1
